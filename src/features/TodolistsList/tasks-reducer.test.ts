...
import {todoListsActions, tasksActions} from "./";
import {tasksReducer, TasksStateType} from "./tasks-reducer";

const {addTodoLists, fetchTodoLists} = todoListsActions
const {addTask, fetchTask, updateTask} = tasksActions
...
test('status of specified task should be changed', () => {
    const updateModel = {
        todoListId: 'todolistId2',
        taskId: '2',
        model: {status: TaskStatuses.Completed} as UpdateTaskModelType
    }
